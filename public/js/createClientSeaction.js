// public/js/createClientSeaction.js
...
export const createClientsSection = () => {
    ...
    addUserBtn.classList.add('clients__btn', 'btn-reset', 'btn', 'btn-primary');
    addUserBtnSvg.classList.add('clients__svg');
    container.classList.add('container', 'clients__container');
    clientsTable.classList.add('clients__table', 'table', 'table-striped');
    ...
    addUserBtn.addEventListener('click', () => {
        addClientModal();  // Вызов функции для открытия модального окна
    });
